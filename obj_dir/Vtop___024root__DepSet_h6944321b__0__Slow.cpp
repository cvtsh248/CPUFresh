...
#endif
                VL_FATAL_MT("cpuf.v", 756, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__cpu__DOT__a_out = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__b_out = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__c_f = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__c_e = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__c_g = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__c_l = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__cpu__DOT__to_a = VL_RAND_RESET_I(8);
    vlSelf->top__DOT__cpu__DOT__bus_i__out__strong__out23 = 0;
