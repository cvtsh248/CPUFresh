...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBus(c+33,"bus_i", false,-1, 7,0);
    ...
    tracep->declBit(c+36,"c_out_acc", false,-1);
    tracep->declBit(c+9,"acc_out", false,-1);
    tracep->declBit(c+10,"ad", false,-1);
    tracep->declBit(c+11,"sb", false,-1);
    tracep->declBit(c+37,"a_out", false,-1);
    tracep->declBit(c+37,"b_out", false,-1);
    tracep->declBit(c+37,"out_bus", false,-1);
    tracep->declBus(c+12,"ir_i", false,-1, 3,0);
    tracep->declBus(c+38,"bus_d", false,-1, 7,0);
    ...
    tracep->declBit(c+34,"clk", false,-1);
    tracep->declBit(c+36,"inp_in", false,-1);
    tracep->declBit(c+9,"out_o", false,-1);
    tracep->declBit(c+37,"out_b", false,-1);
    ...
    tracep->declBit(c+37,"out_o", false,-1);
    tracep->declBit(c+37,"out_b", false,-1);
    ...
    tracep->declBit(c+37,"aflag", false,-1);
    ...
    tracep->declBus(c+43,"OP_MUL", false,-1, 3,0);
    tracep->declBus(c+44,"OP_DIV", false,-1, 3,0);
    tracep->declBus(c+45,"OP_JMP", false,-1, 3,0);
    tracep->declBus(c+46,"OP_HLT", false,-1, 3,0);
    tracep->declBus(c+44,"OP_WRT", false,-1, 3,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+47,"offset", false,-1, 3,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+9,(vlSelf->top__DOT__acc_out));
    bufp->fullBit(oldp+10,(vlSelf->top__DOT__ad));
    bufp->fullBit(oldp+11,(vlSelf->top__DOT__sb));
    bufp->fullCData(oldp+12,(vlSelf->top__DOT__ir__DOT__instruction),4);
    bufp->fullCData(oldp+13,(vlSelf->top__DOT__mar__DOT__address),4);
    bufp->fullCData(oldp+14,(vlSelf->top__DOT__ram__DOT__out_ir),8);
    bufp->fullCData(oldp+15,(vlSelf->top__DOT__to_a),8);
    bufp->fullCData(oldp+16,((((IData)(vlSelf->top__DOT__out_b)
                                ? 0xffU : 0U) & (((IData)(vlSelf->top__DOT__out_b)
                                                 ...
                                                 & ((IData)(vlSelf->top__DOT__out_b)
                                                     ? 0xffU
                                                     : 0U)))),8);
    bufp->fullCData(oldp+17,(vlSelf->top__DOT__to_acc),8);
    bufp->fullCData(oldp+18,(vlSelf->top__DOT__ir__DOT__address),4);
    bufp->fullCData(oldp+19,(vlSelf->top__DOT__alu__DOT__out),8);
    bufp->fullCData(oldp+20,(vlSelf->top__DOT__control__DOT__stagecount),3);
    bufp->fullCData(oldp+21,(vlSelf->top__DOT__counter__DOT__pc),4);
    bufp->fullWData(oldp+22,(vlSelf->top__DOT__ram__DOT__mem),129);
    bufp->fullCData(oldp+27,(vlSelf->top__DOT__ram__DOT__index_ir),8);
    bufp->fullCData(oldp+28,(vlSelf->top__DOT__ram__DOT__index_reg),8);
    bufp->fullCData(oldp+29,(vlSelf->top__DOT__ram__DOT__out_reg),8);
    bufp->fullCData(oldp+30,(vlSelf->top__DOT__areg__DOT__areg),8);
    bufp->fullCData(oldp+31,(vlSelf->top__DOT__breg__DOT__areg),8);
    bufp->fullCData(oldp+32,(vlSelf->top__DOT__accumulator__DOT__areg),8);
    bufp->fullCData(oldp+33,(vlSelf->bus_i),8);
    bufp->fullBit(oldp+34,(vlSelf->clk));
    bufp->fullBit(oldp+35,(vlSelf->reset));
    bufp->fullBit(oldp+36,(1U));
    bufp->fullBit(oldp+37,(0U));
    bufp->fullCData(oldp+38,(0U),8);
    bufp->fullCData(oldp+39,(8U),4);
    bufp->fullCData(oldp+40,(4U),4);
    bufp->fullCData(oldp+41,(2U),4);
    bufp->fullCData(oldp+42,(1U),4);
    bufp->fullCData(oldp+43,(0xcU),4);
    bufp->fullCData(oldp+44,(0xaU),4);
    bufp->fullCData(oldp+45,(9U),4);
    bufp->fullCData(oldp+46,(0xfU),4);
    bufp->fullCData(oldp+47,(vlSelf->top__DOT__mar__DOT__offset),4);
}
